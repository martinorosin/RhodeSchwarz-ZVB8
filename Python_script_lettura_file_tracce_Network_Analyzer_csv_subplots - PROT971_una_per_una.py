...
ax1.grid(True, which='minor', color='k', linestyle='--',linewidth=0.5)
ax1.minorticks_on()

# Sub_plot2: setto le griglie
ax2.grid(True)
ax2.grid(True, which='major', color='k', linestyle='-',linewidth=1)
ax2.grid(True, which='minor', color='k', linestyle='--',linewidth=0.5)
ax2.minorticks_on()
...
ax1.axvline(x = x1, color ='red', linewidth=1.5)
ax1.axvline(x = x2, color ='red', linewidth=1.5)
ax1.axvline(x = x3, color ='red', linewidth=1.5)
ax1.axvline(x = x4, color ='red', linewidth=1.5)

# Subplot2: traccio le limit line verticali
ax2.axvline(x = x1, color ='red', linewidth=1.5)
ax2.axvline(x = x2, color ='red', linewidth=1.5)
ax2.axvline(x = x3, color ='red', linewidth=1.5)
ax2.axvline(x = x4, color ='red', linewidth=1.5)

# Traccio la limit line orizzontale
ax1.axhline(y = y1, color ='green', linewidth=2)
ax2.axhline(y = y1, color ='green', linewidth=2)
